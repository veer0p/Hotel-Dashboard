...
import { Box, Paper, Typography, Button, Divider, Chip, Tabs, Tab } from "@mui/material";
import { Room } from "@/data/mockFloorPlanData";
import { X, User, DollarSign, Calendar, Clock, MessageSquare, CreditCard, LogOut, Plus, Wrench, History, ClipboardList } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                ...
                >
                    <Tab icon={<ClipboardList size={18} />} iconPosition="start" label="Overview" />
                    <Tab icon={<Wrench size={18} />} iconPosition="start" label="Maintenance" />
                </Tabs>
            </Box>
            ...
            <Box sx={{ p: 0 }}>
                {activeTab === 0 ? (
                    ...
                    <Box sx={{ p: 2 }}>
                        <MaintenanceLog roomNumber={room.number} />
                    </Box>
                )}
            </Box>
        </Paper>
