...
import ContextualActionFooter from "@/components/dashboard/ContextualActionFooter";
...
export default function Home() {
  ...
  const handleScheduleAction = useCallback((item: any) => {
    if (item.action === 'check-in') {
      setCheckInModalOpen(true);
    } else {
      console.log('Action clicked:', item.action, 'for guest:', item.guest);
    }
  }, []);
